            ...
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    addressConfig = {
                      tonAddress: "UQCT_lMzL8DPD-1m5Zz8aJ4gqPnliQD_JXv1E3wo-LkEDdn1",
                      jettonAddress: "UQCT_lMzL8DPD-1m5Zz8aJ4gqPnliQD_JXv1E3wo-LkEDdn1"
                    };
...
System.register("chunks:///_virtual/GoTx.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './telegram-web.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Component, TelegramWebApp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "ab0ecQSkB1KUZp5awu/clZf", "GoTx", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var GoTx = exports('GoTx', (_dec = ccclass('GoTx'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inheritsLoose(GoTx, _Component);
        function GoTx() {
          return _Component.apply(this, arguments) || this;
        }
        var _proto = GoTx.prototype;
        _proto.start = function start() {};
        _proto.onDirect = function onDirect() {
          TelegramWebApp.Instance.openLink("https://x.com/Jackybrrs");
        };
        _proto.otherClick = function otherClick() {
          TelegramWebApp.Instance.openLink("https://x.com/intent/retweet?tweet_id=1841144075472523499");
        };
        _proto.windowClick1 = function windowClick1() {
          window.location.href = "https://x.com/Jackybrrs";
        };
        _proto.windowClick2 = function windowClick2() {
          window.location.href = "https://x.com/intent/retweet?tweet_id=1841144075472523499";
        };
        _proto.schemaClick = function schemaClick() {
          window.location.href = "twitter://user?screen_name=Jackybrrs";
        };
        _proto.update = function update(deltaTime) {};
        return GoTx;
      }(Component)) || _class));
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './telegram-web.ts', './Config.ts', './FBCoin.ts', './FBGlobalData.ts', './FBRecordManager.ts', './FBird.ts', './FLevel.ts', './FPipe.ts', './FlappyBirdLite.ts', './GameResult.ts', './GoTx.ts', './ResolutionAdjuster.ts', './ScrollControl.ts', './ToolsView.ts', './Main.ts', './GameBase.ts', './CameraFollowTarget2D.ts', './Countdown.ts', './FollowTarget.ts', './LogManager.ts', './PoolManager.ts', './Singleton.ts', './Utils.ts', './GlobalEvent.ts', './AudioManager.ts'], function () {
  return {
